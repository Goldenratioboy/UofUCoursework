...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/submodules/audio_sample_audio_pll_0_audio_pll.vo \
  $QSYS_SIMDIR/submodules/altera_reset_controller.v \
  $QSYS_SIMDIR/submodules/altera_reset_synchronizer.v \
  $QSYS_SIMDIR/submodules/audio_sample_audio_pll_0.v \
  ...
  $QSYS_SIMDIR/submodules/audio_sample_audio_and_video_config_0.v \
  ...
  $QSYS_SIMDIR/submodules/audio_sample_audio_0.v \
  $QSYS_SIMDIR/audio_sample.v \
  -top $TOP_LEVEL_NAME
# ----------------------------------------
# simulate
