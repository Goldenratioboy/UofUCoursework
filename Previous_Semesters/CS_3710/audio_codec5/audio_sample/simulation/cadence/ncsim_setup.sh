...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/audio_sample_audio_pll_0_audio_pll.vo"            -work audio_pll                -cdslib ./cds_libs/audio_pll.cds.lib               
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/audio_sample_audio_pll_0.v"                       -work audio_pll_0              -cdslib ./cds_libs/audio_pll_0.cds.lib             
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/audio_sample_audio_and_video_config_0.v"          -work audio_and_video_config_0 -cdslib ./cds_libs/audio_and_video_config_0.cds.lib
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/audio_sample_audio_0.v"                           -work audio_0                  -cdslib ./cds_libs/audio_0.cds.lib                 
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/audio_sample.v"                                                                                                                                
fi
